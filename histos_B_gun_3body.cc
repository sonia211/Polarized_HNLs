...
int main() {
	...
	TString FILENAME0 = "./trees/tree_Bgun_25.root";
	TString FILENAME1 = "./trees/tree_Bgun_SS_3body.root";
	TString FILENAME2 = "./trees/tree_Bgun_OS_3body.root";
...
//TString FILENAME4 = "./trees/tree_Bgun_SS.root";
	...
	TH1D* h8_0 = new TH1D("h8_0", "", 50, 0., pi);
	TH1D* h8_1 = new TH1D("h8_1", "", 50, 0., pi);
	TH1D* h8_2 = new TH1D("h8_2", "", 50, 0., pi);
	TH1D* h8_3 = new TH1D("h8_3", "", 50, 0., pi);
	TH1D* h8_4 = new TH1D("h8_4", "", 50, 0., pi);
	
	//
	TCanvas *c9 = new TCanvas("c9","c",800,600);
	TH1D* h9_0 = new TH1D("h9_0", "", 50, 0., pi);
	TH1D* h9_1 = new TH1D("h9_1", "", 50, 0., pi);
	TH1D* h9_2 = new TH1D("h9_2", "", 50, 0., pi);
	TH1D* h9_3 = new TH1D("h9_3", "", 50, 0., pi);
	TH1D* h9_4 = new TH1D("h9_4", "", 50, 0., pi);
	...
	for(int cnt=0; cnt<nent ;cnt++){
		...
		T0->SetBranchAddress("meson_PX",&meson_PX);
		T0->SetBranchAddress("meson_PY",&meson_PY);
		T0->SetBranchAddress("meson_PZ",&meson_PZ);
		T0->SetBranchAddress("meson_E",&meson_E);
		...
		meson_P.Boost(N_P_Boost);	meson_P.Boost(-B_P_Boost);
			...
			meson_P.RotateZ(-1*N_P.Phi());		meson_P.RotateY(-1*N_P.Theta());
		...
		h8_0->Fill(N_P.Angle(mu1_P.Vect()));
		h9_0->Fill(N_P.Angle(meson_P.Vect()));
	...
	for(int cnt=0; cnt<nent; cnt++){
		...
		T1->SetBranchAddress("meson_PX",&meson_PX);
		T1->SetBranchAddress("meson_PY",&meson_PY);
		T1->SetBranchAddress("meson_PZ",&meson_PZ);
		T1->SetBranchAddress("meson_E",&meson_E);
		...
		h8_1->Fill(N_P.Angle(mu1_P.Vect()));
		h9_1->Fill(N_P.Angle(meson_P.Vect()));
	...
	for(int cnt=0; cnt<nent; cnt++){
		...
		T2->SetBranchAddress("meson_PX",&meson_PX);
		T2->SetBranchAddress("meson_PY",&meson_PY);
		T2->SetBranchAddress("meson_PZ",&meson_PZ);
		T2->SetBranchAddress("meson_E",&meson_E);
		...
		h8_2->Fill(N_P.Angle(mu1_P.Vect()));
		h9_2->Fill(N_P.Angle(meson_P.Vect()));
	}
	
	

	TString ODIRNAME = "./_CROSSCHECKS_B_GUN_3BODY";
	...
	/** H8 ************************************************************/
	c8->cd();
	h8_1->GetXaxis()->SetTitle("#angle(N,#mu_{1}) in B restframe");
	h8_0->SetLineColor(kOrange-3); 	 h8_0->SetFillColor(kOrange-3);    h8_0->SetFillStyle(3002); h8_0->SetLineWidth(2); 	h8_0->SetStats(0);
	h8_1->SetLineColor(kCyan-3); 	 h8_1->SetFillColor(kCyan-3);    h8_1->SetFillStyle(3325); h8_1->SetLineWidth(2); 	h8_1->SetStats(0);
	h8_2->SetLineColor(kBlue-3); 	 h8_2->SetFillColor(kBlue-3);    h8_2->SetFillStyle(3352); h8_2->SetLineWidth(2); 	h8_2->SetStats(0);
	//h1_3->SetLineColor(kMagenta-3); 	 h1_3->SetFillColor(kMagenta-3);    h1_3->SetFillStyle(3016); h1_3->SetLineWidth(2); h1_3->SetStats(0);
	//h1_4->SetLineColor(kBlue); 	 h1_4->SetFillColor(kBlue);    h1_4->SetFillStyle(3352); h1_4->SetLineWidth(2); h1_4->SetStats(0);
	
	h8_0->Scale(1/h8_0->Integral("width"));
	h8_1->Scale(1/h8_1->Integral("width"));
	h8_2->Scale(1/h8_2->Integral("width"));
	h8_1->Draw("HIST");
	h8_0->Draw("HISTSAME");
	h8_2->Draw("HISTSAME");
	//h1A_2->Draw("HISTSAME");
	...
	auto legend8 = new TLegend(0.75,0.7,0.9,0.9);
	legend8->AddEntry(h8_0,"OS with #lambda(N)=0","L");	
	legend8->AddEntry(h8_1,"OS #Leftrightarrow #lambda(N)=+1","L");	
	legend8->AddEntry(h8_2,"SS #Leftrightarrow #lambda(N)=-1","L");
	//legend->AddEntry(h1_4,"split, tau, pol -1","L");
	//legend->AddEntry(h1_2,"split, Higgs, no pol","L");
	
	legend6->Draw();
	c8->SaveAs(ODIRNAME+"/H8.root");
	c8->SaveAs(ODIRNAME+"/H8.pdf");
	
	
	/** H9 ************************************************************/
	c9->cd();
	h9_1->GetXaxis()->SetTitle("#angle(N,meson) in B restframe");
	h9_0->SetLineColor(kOrange-3); 	 h9_0->SetFillColor(kOrange-3);    h9_0->SetFillStyle(3002); h9_0->SetLineWidth(2); 	h9_0->SetStats(0);
	h9_1->SetLineColor(kCyan-3); 	 h9_1->SetFillColor(kCyan-3);    h9_1->SetFillStyle(3325); h9_1->SetLineWidth(2); 	h9_1->SetStats(0);
	h9_2->SetLineColor(kBlue-3); 	 h9_2->SetFillColor(kBlue-3);    h9_2->SetFillStyle(3352); h9_2->SetLineWidth(2); 	h9_2->SetStats(0);
	//h1_3->SetLineColor(kMagenta-3); 	 h1_3->SetFillColor(kMagenta-3);    h1_3->SetFillStyle(3016); h1_3->SetLineWidth(2); h1_3->SetStats(0);
	//h1_4->SetLineColor(kBlue); 	 h1_4->SetFillColor(kBlue);    h1_4->SetFillStyle(3352); h1_4->SetLineWidth(2); h1_4->SetStats(0);
	
	h9_0->Scale(1/h9_0->Integral("width"));
	h9_1->Scale(1/h9_1->Integral("width"));
	h9_2->Scale(1/h9_2->Integral("width"));
	h9_1->Draw("HIST");
	h9_0->Draw("HISTSAME");
	h9_2->Draw("HISTSAME");
	//h1A_2->Draw("HISTSAME");
	...
	auto legend9 = new TLegend(0.75,0.7,0.9,0.9);
	legend9->AddEntry(h9_0,"#lambda(N)=0","L");	
	legend9->AddEntry(h9_1,"OS #Leftrightarrow #lambda(N)=+1","L");	
	legend9->AddEntry(h9_2,"SS #Leftrightarrow #lambda(N)=-1","L");
	//legend->AddEntry(h1_4,"split, tau, pol -1","L");
	//legend->AddEntry(h1_2,"split, Higgs, no pol","L");
	
	legend9->Draw();
	c9->SaveAs(ODIRNAME+"/H9.root");
	c9->SaveAs(ODIRNAME+"/H9.pdf");
